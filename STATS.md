...
| Metric | Value |
|---|---|
| Total Rust lines | 425134 (422584 in `crates/` + 2550 in root `src/`/`examples/`) |
| Total Rust files | 1030 (workspace crates) + 5 (root `src/`/`examples/`) |
| Tests defined | ~7946 (6338 external test-file tests + 1608 inline `#[cfg(test)]`) |
| Test files | 472 external + 197 inline-bearing |
| Test binaries | ~488 (472 integration test files + 16 lib/bin targets) |
...
```
ragent-tui             ██████████████████████████████ 80,112 lines (19.0%)
ragent-agent           ████████████████████████████ 74,842 lines (17.7%)
ragent-tools-extended  ██████████████████████ 58,037 lines (13.7%)
ragent-research        █████████████████████ 55,376 lines (13.1%)
ragent-llm             █████████ 23,228 lines ( 5.5%)
ragent-codeindex       █████████ 22,898 lines ( 5.4%)
ragent-specs           ███████ 17,694 lines ( 4.2%)
ragent-tools-core      ██████ 17,018 lines ( 4.0%)
...
| `ragent-tools-core` | 17 | ~224 |
| `ragent-llm` | 21 | ~267 |
| `ragent-server` | 5 | ~92 |
| `ragent-team` | 14 | ~81 |
| `ragent-bench` | 3 | ~50 |
| `ragent-prompt_opt` | 2 | ~8 |
| **Total (external)** | **472** | **~6,338** |

Inline `#[cfg(test)]` modules in library sources contribute a further
1,608 test attributes (largest contributors: `ragent-research` 668,
`ragent-agent` 189, `ragent-specs` 138, `ragent-tools-extended` 135),
bringing the estimated total to ~7,946.

---

## Key Architecture Ratios

- Test-to-code ratio: ~1 test per 54 lines (7,946 tests / 425,134 lines)
- Largest crate: `ragent-tui` (80,112 lines, 19.0%)
