...
Quality-assurance companion document for `Test: replay topic`. Generated together with `RESEARCH.md`; the `[#N]` source indices reference the Sources Reference table at the bottom of this file.
...
Synthesis audit for 'replay topic' scored 62/100 across critics [coverage=50 logic=100 evidence=0 readability=100]; 0/0 sources cited.
...
**Evidence gaps:**
- Gather at least one source for 'replay topic'
...
|---|------|-------|----------|----------|-------|--------|-----------|-----------|-------------|--------|----------|
| 1 | other | — | — | — | No sources captured | — | — | (no gathering run) | — | — | 2026-09-17T01:02:42.033797713+00:00 |
