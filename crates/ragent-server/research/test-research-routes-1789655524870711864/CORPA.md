...
Quality-assurance companion document for `test topic`. Generated together with `RESEARCH.md`; the `[#N]` source indices reference the Sources Reference table at the bottom of this file.
...
Synthesis audit for 'test topic' scored 62/100 across critics [coverage=50 logic=100 evidence=0 readability=100]; 0/0 sources cited.
...
**Evidence gaps:**
- Gather at least one source for 'test topic'
...
|---|------|-------|----------|----------|-------|--------|-----------|-----------|-------------|--------|----------|
| 1 | other | — | — | — | No sources captured | — | — | (no gathering run) | — | — | 2026-09-17T14:32:05.064624850+00:00 |
