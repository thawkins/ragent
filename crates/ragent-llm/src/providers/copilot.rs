...
///
/// ```no_run
/// use ragent_llm::provider::copilot::is_pat_token;
///
...
///
/// ```no_run
/// use ragent_llm::provider::copilot::resolve_copilot_github_token;
///
...
///
/// ```no_run
/// use ragent_llm::provider::copilot::start_copilot_device_flow;
///
...
///
/// ```no_run
/// use ragent_llm::provider::copilot::poll_copilot_device_flow;
///
/// # async fn example() -> anyhow::Result<()> {
...
///
/// ```no_run
/// use ragent_llm::provider::copilot::resolve_copilot_auth;
///
/// # async fn example() -> anyhow::Result<()> {
...
///
/// ```no_run
/// use ragent_llm::provider::copilot::check_copilot_health;
///
/// # async fn example() {
...
///
/// ```no_run
/// use ragent_llm::provider::copilot::discover_copilot_api_base;
///
/// # async fn example() {
...
///
/// ```no_run
/// use ragent_llm::provider::copilot::cached_copilot_plan;
///
...
///
/// ```no_run
/// use ragent_llm::provider::copilot::list_copilot_models;
///
/// # async fn example() -> anyhow::Result<()> {
