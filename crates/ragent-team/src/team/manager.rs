...
impl TeamManager {
    ...
    pub async fn spawn_teammate_internal(
        ...
        let effective_scope = if memory_scope == super::config::MemoryScope::None {
            match agent.memory {
                ragent_agent::team::config::MemoryScope::None => super::config::MemoryScope::None,
                ragent_agent::team::config::MemoryScope::User => super::config::MemoryScope::User,
                ragent_agent::team::config::MemoryScope::Project => {
                    super::config::MemoryScope::Project
                }
            }
        } else {
            memory_scope
