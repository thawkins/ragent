...
//!   Semantic search is skipped and structured memory queries fall back to
//!   full-text search (`memory_recall`).
//!
...
///
/// ```
/// use ragent_tools_extended::memory::embedding::{EmbeddingProvider, NoOpEmbedding};
///
...
///
/// ```
/// use ragent_tools_extended::memory::embedding::cosine_similarity;
///
