...
//! Source code files are parsed with tree-sitter via `ragent-codeindex` to produce
...
pub enum DocumentType {
    ...
    SourceCode {
        /// The language id recognised by `ragent_codeindex::parser::ParserRegistry`
    ...
    pub fn from_path<P: AsRef<Path>>(path: P) -> Self {
        ...
        match extension.as_deref() {
            ...
            _ => {
                ...
                if let Some(lang) = ragent_codeindex::scanner::detect_language(path) {
...
fn kind_label(kind: &ragent_codeindex::types::SymbolKind) -> &'static str {
    use ragent_codeindex::types::SymbolKind;
    match kind {
