...
fn simplify_skill() -> SkillInfo {
    make_bundled_skill(
        ...
        vec![
            ...
            "codeindex_symbols".to_string(),
            "codeindex_references".to_string(),
            "codeindex_dependencies".to_string(),
            "codeindex_status".to_string(),
            "codeindex_reindex".to_string(),
            "codeindex_explain".to_string(),
            "codeindex_path".to_string(),
            "codeindex_communities".to_string(),
            "codeindex_godnodes".to_string(),
        ],
        SIMPLIFY_BODY,
    )
}
