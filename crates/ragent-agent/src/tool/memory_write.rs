...
// ── Tests for whitespace-tolerant memory_replace (WSPLAN M2-T2) ───────────────
//
...
mod replace_matcher_tests {
    ...
    fn memory_replace_tolerates_final_newline_mismatch() {
        // Block content has trailing newline; needle lacks it.
    ...
    fn memory_replace_tolerates_blank_line_in_needle() {
        // Needle has a leading blank line the block lacks.
