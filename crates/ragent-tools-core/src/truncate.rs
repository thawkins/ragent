...
//!
//! ```
//! use ragent_tools_core::truncate::truncate_content;
//!
//! let content = "line1\nline2\nline3\nline4\nline5";
...
///
/// ```
/// use ragent_tools_core::truncate::truncate_content_head_tail;
///
...
///
/// ```
/// use ragent_tools_core::truncate::get_truncation_stats;
///
