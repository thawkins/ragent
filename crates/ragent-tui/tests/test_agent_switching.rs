...
async fn press_tab(app: &mut App) {
...
#[tokio::test]
async fn test_agent_switch_cycles_through_agents() {
...
#[tokio::test]
async fn test_agent_switch_updates_status_bar() {
    let bus = Arc::new(EventBus::default());
    let mut app = make_app(bus);
...
#[tokio::test]
async fn test_agent_switch_pushes_log_entry() {
    let bus = Arc::new(EventBus::default());
    let mut app = make_app(bus);
...
#[tokio::test]
async fn test_agent_switch_publishes_event_with_session() {
    let bus = Arc::new(EventBus::default());
...
#[tokio::test]
async fn test_agent_switch_no_event_without_session() {
    let bus = Arc::new(EventBus::default());
    let mut rx = bus.subscribe();
    let mut app = make_app(bus);
...
#[tokio::test]
async fn test_agent_switch_updates_agent_info() {
    let bus = Arc::new(EventBus::default());
    let mut app = make_app(bus);
...
#[tokio::test]
async fn test_agent_switch_index_tracking() {
    let bus = Arc::new(EventBus::default());
    let mut app = make_app(bus);
...
#[tokio::test]
async fn test_agent_switch_full_cycle_names() {
    let bus = Arc::new(EventBus::default());
    let mut app = make_app(bus);
