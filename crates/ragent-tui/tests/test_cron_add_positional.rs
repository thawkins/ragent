...
#[tokio::test]
async fn test_cron_add_with_named_id_every_repeat() {
...
#[tokio::test]
async fn test_cron_add_with_named_id_from_repeat() {
    let mut app = make_app();
    app.session_id = Some("test-session".to_string());
...
#[tokio::test]
async fn test_cron_add_missing_schedule_shows_usage() {
    let mut app = make_app();
    app.session_id = Some("test-session".to_string());
...
#[tokio::test]
async fn test_cron_add_missing_prompt_shows_usage() {
    let mut app = make_app();
    app.session_id = Some("test-session".to_string());
    app.execute_slash_command("/cron add nightly general every 30m Run tests")
        .await;
...
#[tokio::test]
async fn test_cron_add_empty_shows_usage() {
    let mut app = make_app();
    app.session_id = Some("test-session".to_string());
    app.execute_slash_command("/cron add").await;
...
#[tokio::test]
async fn test_cron_add_uses_cronname_as_id_not_autogenerated() {
    let mut app = make_app();
    app.session_id = Some("test-session".to_string());
...
#[tokio::test]
async fn test_cron_help_shows_positional_params() {
    let mut app = make_app();
    app.session_id = Some("test-session".to_string());
    app.execute_slash_command("/cron help").await;
...
#[tokio::test]
async fn test_cron_add_natural_time_5pm() {
    let mut app = make_app();
    app.session_id = Some("test-session".to_string());
...
#[tokio::test]
async fn test_cron_add_natural_time_5_30pm() {
    let mut app = make_app();
    app.session_id = Some("test-session".to_string());
...
#[tokio::test]
async fn test_cron_add_natural_time_24_hour() {
    let mut app = make_app();
    app.session_id = Some("test-session".to_string());
...
#[tokio::test]
async fn test_cron_add_natural_time_from_5pm_every_1h() {
    let mut app = make_app();
    app.session_id = Some("test-session".to_string());
...
#[tokio::test]
async fn test_cron_add_natural_time_5pm_tomorrow() {
    let mut app = make_app();
    app.session_id = Some("test-session".to_string());
...
#[tokio::test]
async fn test_cron_add_natural_time_invalid_time() {
    let mut app = make_app();
    app.session_id = Some("test-session".to_string());
...
#[tokio::test]
async fn test_cron_help_shows_natural_language_timestamps() {
    let mut app = make_app();
    app.session_id = Some("test-session".to_string());
    app.execute_slash_command("/cron help").await;
    assert_eq!(app.status, "cron: help");
...
#[tokio::test]
async fn test_cron_detail_shows_full_prompt() {
    let mut app = make_app();
    app.session_id = Some("test-session".to_string());
    let long_prompt =
    ...
    app.execute_slash_command("/cron detail nightly").await;
...
#[tokio::test]
async fn test_cron_detail_not_found() {
    let mut app = make_app();
    app.session_id = Some("test-session".to_string());
    app.execute_slash_command("/cron detail nonexistent").await;
...
#[tokio::test]
async fn test_cron_detail_no_id_shows_usage() {
    let mut app = make_app();
    app.session_id = Some("test-session".to_string());
    app.execute_slash_command("/cron detail").await;
...
#[tokio::test]
async fn test_cron_help_lists_detail_subcommand() {
    let mut app = make_app();
    app.session_id = Some("test-session".to_string());
    app.execute_slash_command("/cron help").await;
    let out = last_text(&app);
...
async fn test_cron_disable_then_enable() {
    ...
    // Disable it.
    app.execute_slash_command("/cron disable nightly").await;
    ...
    // Re-enable it.
    app.execute_slash_command("/cron enable nightly").await;
...
async fn test_cron_enable_not_found() {
    let mut app = make_app();
    app.session_id = Some("test-session".to_string());
    app.execute_slash_command("/cron enable nonexistent").await;
...
#[tokio::test]
async fn test_cron_disable_no_id_shows_usage() {
    let mut app = make_app();
    app.session_id = Some("test-session".to_string());
    app.execute_slash_command("/cron disable").await;
...
#[tokio::test]
async fn test_cron_enable_no_id_shows_usage() {
    let mut app = make_app();
    app.session_id = Some("test-session".to_string());
    app.execute_slash_command("/cron enable").await;
...
#[tokio::test]
async fn test_cron_help_lists_enable_disable() {
    let mut app = make_app();
    app.session_id = Some("test-session".to_string());
    app.execute_slash_command("/cron help").await;
    let out = last_text(&app);
