...
- **AIWiki feature removed** — Removed the AIWiki crate, slash commands, tools, runtime/config wiring, examples, and dedicated user documentation. Repository docs now reflect the post-AIWiki product surface.
...
## [0.1.0-alpha.51] - 2026-04-22

### Added
- **SPEC.md figure captions** — Added descriptive captions below all 13 mermaid diagrams derived from the "List of diagrams" table for clearer documentation.
