...
| T-007 | Add `Reverse` slash-command parsing: positional repo URL, `--tech <stack>`, `--create <name>`, `help` subcommand | FR-002, FR-011, FR-013 | M | High | completed | T-006 |
...
4. **Milestone 4 — Optional flags and error handling** (T-007, T-008, T-011, T-012)
   - `--tech`, `--create`, and all error paths work.
