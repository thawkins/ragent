...
| T-004 | Define `ResearchItem` struct with frontmatter fields | FR-005 | S | Critical | completed | T-001, T-002, T-003 |
| T-005 | Create `ragent-research` crate skeleton with Cargo.toml | NFR-007 | S | Critical | completed | — |
| T-006 | Implement atomic directory + `RESEARCH.md` skeleton creation | FR-001, FR-005 | M | Critical | completed | T-004, T-005 |
| T-007 | Implement `ResearchManager::create` with name validation and FR-001 layout | FR-001, FR-002 | M | Critical | completed | T-006 |
| T-008 | Implement `ResearchManager::list` with status filtering and sort | FR-004, FR-013 | M | High | completed | T-006 |
| T-009 | Implement `ResearchManager::show` returning parsed item | FR-004 | S | High | completed | T-006 |
| T-010 | Implement `ResearchManager::delete` with confirmation hook | FR-004 | S | High | completed | T-006 |
| T-011 | Implement `ResearchManager::archive` setting status=archived | FR-013 | S | Medium | completed | T-008 |
| T-012 | Implement `research/INDEX.md` derived cache writer | FR-012 | M | High | completed | T-006 |
| T-013 | Implement atomic write-then-rename for all file operations | NFR-002 | S | High | completed | T-006 |
| T-014 | Implement web-gathering phase using websearch + webfetch | FR-006, FR-007 | L | Critical | completed | T-005 |
| T-015 | Implement `sources/web-<NN>.md` supporting-file writer | FR-007 | S | High | completed | T-014 |
| T-016 | Implement local-gathering phase using glob + grep + read | FR-006, FR-008 | L | Critical | completed | T-005 |
| T-017 | Implement `sources/local-<NN>.md` excerpt writer | FR-008 | S | High | completed | T-016 |
| T-018 | Implement in-project cross-referencing scoring | FR-009 | L | High | completed | T-016 |
| T-019 | Implement `ResearchSession` orchestrating all gathering phases | FR-006 | L | Critical | completed | T-014, T-016, T-018 |
| T-020 | Implement `RESEARCH.md` section assembly (8 required sections) | FR-010 | M | Critical | completed | T-019 |
| T-021 | Implement References Index table generation | FR-011 | M | Critical | completed | T-015, T-017, T-020 |
| T-022 | Implement numbering of references and cross-document citations | FR-010 | S | High | completed | T-021 |
| T-023 | Implement `--sources-dir` flag handling | FR-019 | S | Medium | completed | T-016 |
| T-024 | Implement research template loading and `{{var}}` substitution | FR-020 | M | Low | completed | T-020 |
| T-025 | Register `/research` slash command in TUI input handler | FR-003 | M | Critical | completed | T-007 |
| T-026 | Implement TUI autocomplete for sub-commands and names | FR-022 | M | High | completed | T-025, T-008 |
| T-027 | Implement `/research create` triggering `ResearchSession` with live log streaming | FR-003, FR-006 | L | Critical | completed | T-019, T-025 |
| T-028 | Implement `/research list` TUI view (tabular) | FR-004 | M | High | completed | T-008, T-025 |
| T-029 | Implement `/research open` opening markdown viewer | FR-004, FR-021 | M | High | completed | T-009, T-025 |
| T-030 | Implement `/research search` full-text search | FR-004 | M | High | completed | T-025 |
| T-031 | Implement `/research show` metadata view | FR-004 | S | High | completed | T-009, T-025 |
| T-032 | Implement `/research delete` confirmation flow | FR-004 | M | High | completed | T-010, T-025 |
| T-033 | Implement concurrent-edit detection in markdown viewer | FR-021 | M | Medium | completed | T-029 |
| T-034 | Implement `ragent research` CLI sub-commands | FR-014 | M | High | completed | T-007–T-011 |
| T-035 | Implement JSON progress emitter for CLI mode | FR-014 | S | Medium | completed | T-034 |
| T-036 | Implement `POST /research` HTTP endpoint | NFR-007 | M | High | completed | T-019, T-034 |
| T-037 | Implement `GET /research` index endpoint | NFR-007 | S | High | completed | T-012, T-034 |
| T-038 | Implement `GET /research/<name>` single-item endpoint | NFR-007 | S | High | completed | T-009, T-037 |
| T-039 | Implement `DELETE /research/<name>` with confirmation token | NFR-007 | M | Medium | completed | T-010, T-037 |
| T-040 | Parse `research: <name>` line in PLAN.md | FR-015 | S | Medium | completed | T-005 |
| T-041 | Add `Related Research` section template to ragent-specs | FR-015 | S | Medium | completed | T-040 |
| T-042 | Implement `--from-research <name>` flag on `/spec create` | FR-015 | M | Medium | completed | T-040, T-041 |
| T-043 | Surface research links in `/spec list` output | FR-015 | S | Medium | completed | T-040 |
| T-044 | Implement duplicate-name error path with suggestion (FR-016) | FR-016 | S | High | completed | T-007 |
| T-045 | Implement path-traversal rejection (FR-017) | FR-017 | S | High | completed | T-001 |
| T-046 | Implement "not found" error with three closest names (FR-018) | FR-018 | S | High | completed | T-009 |
| T-047 | Add `tracing::info!` calls for session lifecycle and source capture | NFR-004 | S | High | completed | T-019 |
| T-048 | Implement path sanitization for portable output | NFR-005 | S | High | completed | T-020 |
| T-049 | Implement untrusted-source escaping/fencing in RESEARCH.md | NFR-006 | M | High | completed | T-020 |
| T-050 | Add criterion benchmark for gathering engine | NFR-001 | M | Low | completed | T-019 |
| T-051 | Add unit tests for name validation (15+ cases) | FR-002 | S | High | completed | T-001 |
| T-052 | Add integration tests for full create→list→delete flow | FR-001, FR-004, FR-013 | M | High | completed | T-007, T-008, T-010 |
| T-053 | Add TUI snapshot tests for `/research` views | FR-004, FR-022 | M | Medium | completed | T-026, T-028 |
| T-054 | Add end-to-end test: research → spec → implement | FR-015 | L | Medium | completed | T-027, T-042 |
| T-055 | Update `SPEC.md`, `QUICKSTART.md`, `README.md` with research workflow | NFR-007 | S | High | completed | T-027, T-034 |
| T-056 | Add Research section to `docs/research.md` user guide | NFR-007 | S | Medium | completed | T-055 |
## Risks & Mitigations
